...
import 'intro_screen_2.dart'; // Import the second intro screen
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Center(
              child: Image.asset(
                'assets/images/intro1.png', // Path to the PNG file
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Find your partner with Taaruf', // Title
                    ...
                    Text(
                      'Join a community that values connections and start your journey towards finding your ideal partner.', // Description
                      textAlign: TextAlign.center,
                      style: TextStyle(
