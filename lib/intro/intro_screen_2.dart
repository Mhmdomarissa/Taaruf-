      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Center(
              child: Image.asset(
                'assets/images/intro2.png', // Path to the PNG file
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Create Authentic Connections', // Title
                    ...
                    Text(
                      'Build genuine relationships by connecting with people who share your values and interests.', // Description
                      textAlign: TextAlign.center,
                      style: TextStyle(
